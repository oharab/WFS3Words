...
### Core Functionality
The service converts geographic coordinates to What3Words 3-word addresses through a WFS interface. Other W3W operations (reverse geocoding, autosuggest) are out of scope as they don't fit the WFS paradigm.
